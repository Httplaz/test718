...
public class Gun extends Item
{
    ...
    public Gun()
    {
        ...
        super((TextureRegion) Resourses.getResourse("textures/items/tools.png:48 0 16 16", TextureRegion.class), 1, 1, "Gun", (Sound)Resourses.getResourse("sounds/items/gun.mp3", Sound.class));
        super.setId(77);
        useVolume = 0.4f;
        staminaCost = 1;
    }
    ...
    public boolean use(Entity e, World w)
    {
        ...
        Entity b = new GunBullet(e.getPosition().add(bias).add(e.getRotationVec2().scl(1)), e.getRotationVec2().add(bias), w);
