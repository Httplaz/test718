...
public class BlueLightsword extends Item
{

    public int chargeTime;
    public boolean charging = false;

    public BlueLightsword()
    {
        //Tile tile = Tiles.getTile(id);
        super((TextureRegion) Resourses.getResourse("textures/items/tools.png:80 16 16 16", TextureRegion.class), 1, 1, "blueSword", (Sound)Resourses.getResourse("sounds/items/murasama.wav", Sound.class));
        super.setId(77);
        cooldownTime = 3;
    }
    @Override
    ...
    public void noUse(Entity e, World w)
    {
        if(chargeTime>0)
        {
            ...
            w.addEntity(new MuramasaSlash(e.getPosition().add(bias).add(e.getRotationVec2().scl(1)), e.getRotationVec2().add(bias), w, chargeTime));
