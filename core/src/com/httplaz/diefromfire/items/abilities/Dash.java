...
public class Dash extends Item
{
    public Dash()
    {
        ...
        super((TextureRegion) Resourses.getResourse("textures/items/abilities.png:16 0 16 16", TextureRegion.class), 1, 1, "dash", (Sound)Resourses.getResourse("sounds/items/dash.mp3", Sound.class));
        super.setId(77);
        useVolume = 1.f;
        staminaCost = 2;
        cooldownTime = 2;
    ...
    public boolean use(Entity e, World w)
    {
        ...
        if(!super.use(e, w))
            return false;
        e.kick(e.target.cpy().sub(e.getPosition()).nor().scl(0.8f));
        return true;
    }
}
